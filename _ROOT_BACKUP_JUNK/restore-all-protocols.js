...
// Este script lê as migrations SQL e gera o arquivo clinical-protocols.ts completo

const fs = require('fs');
const path = require('path');

// Ler os 3 protocolos existentes que devem ser mantidos
...
console.log('✅ Backup criado: clinical-protocols.ts.backup');
console.log('📝 Total de protocolos a serem restaurados: 28');
console.log('⚠️  Este script precisa ser completado manualmente devido ao limite de tokens.');
console.log('');
console.log('Os protocolos estão nas migrations SQL em:');
console.log('  - supabase/migrations/20260102160000_seed_womens_health_protocols.sql (4 protocolos)');
console.log('  - supabase/migrations/20260102170000_add_knee_protocols.sql (4 protocolos)');
console.log('  - supabase/migrations/20260102180000_add_shoulder_protocols.sql (3 protocolos)');
console.log('  - supabase/migrations/20260102190000_add_ankle_foot_protocols.sql (5 protocolos)');
console.log('  - supabase/migrations/20260102200000_add_hip_spine_protocols.sql (4 protocolos)');
console.log('  - supabase/migrations/20260102210000_add_upper_limb_protocols.sql (5 protocolos)');
console.log('  - supabase/migrations/20260102220000_add_neuro_spine_protocols.sql (3 protocolos)');
