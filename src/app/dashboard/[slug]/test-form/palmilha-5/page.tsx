...
export default function Palmilha5SandboxPage() {
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-1 group cursor-pointer">
                            <Select value="palmilha-5" onValueChange={handleFormChange}>
                                ...
                                <SelectContent className="z-[100]">
                                    <SelectGroup>
                                        <SelectItem value="palmilha-5" className="font-bold text-indigo-600">Palmilha 5.0 (BETA MIGRATION)</SelectItem>
                                        ...
                                        <SelectItem value="ultimate-pbe">✨ Ultimate PBE (Fusão)</SelectItem>
