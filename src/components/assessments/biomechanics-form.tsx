    ...
    return (
        <div className="space-y-8 pb-20">
            ...
            <div className="space-y-8">
                {/* 1. Patient Data */}
                <section>
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2"><FileText className="w-5 h-5 text-slate-400" /> Dados do Paciente</h3>
                    <PatientDataStep data={data} updateField={updateField} readOnly={readOnly} />
                </section>

                {/* 2. Pain Map */}
                <section>
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2"><Activity className="w-5 h-5 text-red-400" /> Mapa de Dor</h3>
                    <Card>
                        <CardHeader>
                ...
                {/* 3. Postural */}
                <section>
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2"><Ruler className="w-5 h-5 text-blue-400" /> Avaliação Postural</h3>
                    <PosturalStep data={data} updateField={updateField} readOnly={readOnly} />
                </section>

                {/* 4. Functional */}
                <section>
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2"><Dumbbell className="w-5 h-5 text-orange-400" /> Testes Funcionais</h3>
                    <FunctionalStep data={data} updateField={updateField} readOnly={readOnly} fpiLeft={fpiLeft} fpiRight={fpiRight} />
                </section>

                {/* 5. Shoe Analysis */}
                <section>
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2"><Footprints className="w-5 h-5 text-purple-400" /> Análise de Calçados</h3>
                    <ShoeAnalysisStep
                        data={data}
