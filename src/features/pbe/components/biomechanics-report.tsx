    ...
    return (
        <div id="report-wrapper" className="fixed inset-0 z-[999] bg-white flex flex-col animate-in fade-in duration-300 overflow-hidden">
            ...
            <div className="h-16 border-b flex items-center justify-between px-4 md:px-6 bg-slate-900 text-white shrink-0 print:hidden">
                <h2 className="font-extrabold text-sm md:text-lg flex items-center gap-2 uppercase tracking-tighter"><Activity className="text-blue-400" /> Biomecânico</h2>
                <div className="flex gap-2 md:gap-4">
                    <Button variant="ghost" onClick={onClose} className="text-slate-300 hover:text-white px-2 md:px-4 text-xs md:text-sm">Fechar</Button>
                    <Button onClick={() => window.print()} className="bg-blue-600 hover:bg-blue-500 font-bold shrink-0 text-xs md:text-sm h-9 md:h-10 px-3 md:px-4">
                        <Send className="w-4 h-4 mr-1 md:mr-2" /> <span className="hidden sm:inline">Imprimir / </span>PDF
                    </Button>
                </div>
            </div>
            ...
            <div id="report-scroll-area" className="flex-1 overflow-auto bg-slate-100 p-0 md:p-8 print:p-0 print:bg-white custom-scrollbar">
                {/* Mobile Thumbnail Wrap (scales paper to ~30% on mobile) */}
                <div className="w-full flex justify-center py-4 md:py-0">
                    <div id="report-paper" className="bg-white w-[210mm] min-w-[210mm] min-h-[297mm] shadow-2xl print:shadow-none print:max-w-none print:w-[210mm] print:h-auto overflow-hidden origin-top scale-[0.35] md:scale-100 transition-transform duration-500">
